    ...
    tab === "tips"
      ...
      : tab === "access"
        ? {
            ...
            sub: "রিপোর্ট আপডেট — টিম সাইটে প্রকাশ করবে",
            Icon: BadgeCheck,
          }
        : {
            ...
            {tab === "tips" ? (
              <>
                <ChatBubble tone="tips">
                  ভিডিও YouTube বা Facebook-এ থাকলে শুধু সেই লিংক পাঠান। বাকি
                  সব — আপলোড, যাচাই, প্রকাশ — নজর টিম করে দেবে।
                </ChatBubble>
                <ChatBubble tone="tips">
                  আপনার কাজ শুধু লিংক দিয়ে সাহায্য করা। পাবলিক ভিডিওর জন্য এটাই
                  মূল উদ্দেশ্য — লিংক দিলেই যথেষ্ট।
                </ChatBubble>
                <ChatBubble tone="tips">
                  প্রাইভেট ভিডিও হলে Google Drive লিংক বা ইমেইলে বিস্তারিতসহ
                  পাঠান। বাকিটা আমরা সামলে নেব। পরিচয় প্রকাশ হবে না।
                </ChatBubble>
              </>
            ) : null}
            ...
            {tab === "access" ? (
              <>
                <ChatBubble tone="access">
                  পুলিশ/তদন্ত কর্মকর্তা শুধু ভিডিও খুলে তদন্ত রিপোর্ট আপডেট ও
                  রিপোর্ট সাবমিট করবেন।
                </ChatBubble>
                <ChatBubble tone="access">
                  আমরা যাচাই করে সাইটে আপডেট করব। সাধারণ নাগরিক এই ঠিকানায়
                  ভিডিও পাঠাবেন না।
                </ChatBubble>
                <ChatBubble tone="access">
                  অ্যাক্সেস চাইলে নিচের ইমেইলে আবেদন করুন — নাম, পদবি,
                  থানা/ইউনিট। অনুমোদন হলে কোড পাঠানো হবে।
                </ChatBubble>
              </>
            ) : null}
